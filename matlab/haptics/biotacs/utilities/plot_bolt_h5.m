function [] = plot_bolt_h5(path_to_h5, object_index)
...
object_list = process_h5_file( path_to_h5, true);
...
h = figure;
hold on;
set(h, 'position', [21, 200, figure_width, figure_width/aspect_ratio])
...
ymax = max(ylim);
str1 = {'Center'};
text( (tap_ind + center_grip_resize_ind)/2 ,ymax*1.2, str1,'HorizontalAlignment','center', 'FontWeight', 'bold');
str1_5 = {'Tap'};
text( (squeeze_ind + tap_ind)/2 ,ymax*1.2, str1_5,'HorizontalAlignment','center', 'FontWeight', 'bold');
str2 = {'Squeeze'};
text( (thermal_ind + squeeze_ind)/2 ,ymax*1.2, str2,'HorizontalAlignment','center', 'FontWeight', 'bold');
str3 = {'Static Hold'};
text( (slow_slide_ind + thermal_ind)/2 ,ymax*1.2, str3,'HorizontalAlignment','center', 'FontWeight', 'bold');
str4 = {'Slow Slide'};
text( (fast_slide_ind + slow_slide_ind)/2 ,ymax*1.2, str4,'HorizontalAlignment','center', 'FontWeight', 'bold');
str5 = {'Fast Slide'};
text( (done_resize_ind + fast_slide_ind)/2 ,ymax*1.2, str5,'HorizontalAlignment','center', 'FontWeight', 'bold');
...
plot(relevant_x,z_tf(start_ind:end_ind), 'Color', [2 129 104]/255, 'LineWidth',plot_line_width);
