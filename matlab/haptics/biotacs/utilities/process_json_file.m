function [ all_data_robot, number_fingers ] = process_json_file( fileID )
...
if (pr2_transforms)
    all_data_robot = struct('biotac',{},'transforms',{},'joint_states',{}, 'controller_state', {},'gripper_accelerometer',{});
