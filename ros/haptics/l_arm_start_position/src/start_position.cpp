...
public:
  ...
  */
  pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.points[ind].positions[0] = 0.65710349343770069;
    goal.trajectory.points[ind].positions[1] = 0.77418472499059587;
    goal.trajectory.points[ind].positions[2] = 1.3199864788479072;
    goal.trajectory.points[ind].positions[3] = -1.3472406736546285;
    goal.trajectory.points[ind].positions[4] = 3.9321632525927885;
    goal.trajectory.points[ind].positions[5] = -0.58635794556653098;
    goal.trajectory.points[ind].positions[6] = -4.704092199987821;
    // Velocities
